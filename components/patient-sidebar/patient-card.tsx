  ...
  return (
    <li className="list-none">
      <button
        ...
        className={cn(
          'relative flex w-full flex-col gap-2 rounded-2xl p-3 text-left transition-all duration-150',
      ...
      >
        ...
        <div className="flex flex-wrap items-center gap-1">
          {patient.currentVitals.hr > 100 && (
            <span className="inline-flex items-center gap-1 rounded-md bg-rose-50 px-1.5 py-0.5 font-mono text-[10px] text-rose-600">
              <HeartPulse className="size-2.5" /> {patient.currentVitals.hr}
            </span>
          )}
          {patient.currentVitals.spo2 < 92 && (
            <span className="inline-flex items-center gap-1 rounded-md bg-cyan-50 px-1.5 py-0.5 font-mono text-[10px] text-cyan-700">
